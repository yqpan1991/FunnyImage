 ...
 */
public class EsPreferencesUtils {

    public static String PREFERENCE_NAME = "custom_data";

    private EsPreferencesUtils() {
    ...
    public static void putString(Context context, String key, String value) {
        ...
        PreferencesCompat.submit(editor);
    }
    ...
    private static class PreferencesCompat{
