 ...
 */
public class EsArrayUtils {

    private EsArrayUtils() {
    ...
    public static <V> V getLast(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (EsObjectUtils.isEquals(value, sourceArray[i])) {
                currentPosition = i;
                break;
            }
        }
    ...
    /**
     * @see {@link EsArrayUtils#getLast(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link EsArrayUtils#getNext(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link EsArrayUtils#getLast(Object[], Object, Object, boolean)} Object is Long
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue, boolean isCircle) {
        ...
        Long[] array = EsObjectUtils.transformLongArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link EsArrayUtils#getNext(Object[], Object, Object, boolean)} Object is Long
     */
    ...
    /**
     * @see {@link EsArrayUtils#getLast(Object[], Object, Object, boolean)} Object is Integer
     */
    public static int getLast(int[] sourceArray, int value, int defaultValue, boolean isCircle) {
        ...
        Integer[] array = EsObjectUtils.transformIntArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link EsArrayUtils#getNext(Object[], Object, Object, boolean)} Object is Integer
     */
